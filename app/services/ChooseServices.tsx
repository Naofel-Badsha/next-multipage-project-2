      ...
      <div className="grid md:grid-cols-2 items-center gap-20 py-24">
        <div>
          ...
          <div className="flex items-center  gap-5 mt-5">
             ...
             <div>
                <h1 className="text-xl font-medium mt-6">Extensive Property Network</h1>
                <p className='text-[16px] mt-1'>Access to a wide range of properties across multiple locations</p>
             </div>
          </div>
          {/*--------Icon------2------*/}
          <div className="flex items-center  gap-5 mt-5">
             ...
             <div>
                ...
                <p className='text-[16px] mt-1'>Dedicated professionals ready to assist you at every step</p>
             </div>
          </div>
          {/*--------Icon------3------*/}
          <div className="flex items-center  gap-5 mt-5">
             ...
             <div>
                ...
                <p className='text-[16px] mt-1'>Safe and protected payment processing for all transactions</p>
             </div>
          </div>
        </div>
